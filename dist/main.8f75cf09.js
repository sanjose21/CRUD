...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../node_modules/dexie/dist/dexie.mjs":[function(require,module,exports) {
...
exports.default = exports.RangeSet = exports.Dexie = void 0;
...
var getIteratorOf = _typeof(iteratorSymbol) === "symbol" ? function (x) {
  var i;
        ...
        var nextChunk = function (offset) {
          ...
          return coreTable.getMany({
            ...
            return Promise.resolve(addValues.length > 0 && coreTable.mutate({
              ...
              return (putValues.length > 0 || criteria && _typeof(changes) === 'object') && coreTable.mutate({
                trans: trans,
                type: 'put',
                keys: putKeys,
                values: putValues,
...
exports.default = exports.Dexie = Dexie$1;
  ...
  globalEvents(DEXIE_STORAGE_MUTATED_EVENT_NAME, function (changedParts) {
    try {
      if (!propagatingLocally) {
        ...
        if (_typeof(self['clients']) === 'object') {
...
exports.getData = exports.default = exports.createUser = exports.createEle = exports.bulkcreate = exports.SortObj = void 0;
var productsdb = function productsdb(dbname, table) {
  var db = new Dexie(dbname);
  db.version(1).stores(table);
  db.open();
  return db;
};
var bulkcreate = function bulkcreate(dbtable, data) {
  var flag = empty(data);
  if (flag) {
...
var createUser = function createUser(dbtable, data) {
  var flag = empty(data);
  if (flag) {
    dbtable.bulkAdd([{
...
var createEle = function createEle(tagname, appendTo, fn) {
...
var getData = function getData(dbname, fn) {
  var index = 0;
  var obj = {};
  dbname.count(function (count) {
    if (count) {
      dbname.each(function (table) {
        obj = SortObj(table);
        fn(obj, index++);
      });
    } else {
...
var SortObj = function SortObj(sortobj) {
  var obj = {};
  obj = {
    id: sortobj.id,
    name: sortobj.name,
    seller: sortobj.description,
    price: sortobj.price
  };
  return obj;
};
exports.SortObj = SortObj;
var _default = productsdb;
...
var db = (0, _module.default)("Productdb", {
...
loginForm.addEventListener('submit', function (event) {
  ...
  db.users.where({
    ...
    if (count > 0) {
      ...
      var loginSuccessMsg = document.querySelector('.login-success-msg');
...
registerForm.addEventListener('submit', function (event) {
  ...
  var username = formData.get('username');
  var password = formData.get('password');
  var isManager = formData.get('is-manager') === 'on';
  (0, _module.bulkcreate)(db.users, {
    username: username,
    password: password,
    isManager: isManager
  });
  ...
  // Display success message
  var insertMsg = document.querySelector('.insertmsg');
...
btncreate.onclick = function (event) {
  var flag = (0, _module.bulkcreate)(db.products, {
    name: proname.value,
    description: description.value,
    price: price.value
  });
  proname.value = description.value = price.value = "";
  (0, _module.getData)(db.products, function (data) {
...
btnupdate.onclick = function () {
  var id = parseInt(userid.value || 0);
  if (id) {
    db.products.update(id, {
      ...
      var get = updated ? true : false;
      var updatemsg = document.querySelector(".updatemsg");
      getMsg(get, updatemsg);
      proname.value = description.value = price.value = "";
    });
  } else {
    console.log("Please Select id: ".concat(id));
  }
};
btndelete.onclick = function () {
  db.delete();
  db = (0, _module.default)("Productdb", {
    products: "++id, name, description, price",
...
function table() {
  ...
  (0, _module.getData)(db.products, function (data, index) {
    if (data) {
      (0, _module.createEle)("tr", tbody, function (tr) {
        var _loop = function _loop(value) {
          (0, _module.createEle)("td", tr, function (td) {
            td.textContent = data.price === data[value] ? "$ ".concat(data[value]) : data[value];
          });
        };
        ...
        (0, _module.createEle)("td", tr, function (td) {
          (0, _module.createEle)("i", td, function (i) {
...
var editbtn = function editbtn(event) {
  var id = parseInt(event.target.dataset.id);
  db.products.get(id, function (data) {
    var newdata = (0, _module.SortObj)(data);
...
},{"dexie":"../node_modules/dexie/dist/dexie.mjs","./module.js":"../js/module.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
